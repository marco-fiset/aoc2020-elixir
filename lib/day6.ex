defmodule Aoc2020.Day6 do
  def part1(input) do
    input
    |> split_groups()
    |> count_answers(&distinct_answers/1)
  end

  def part2(input) do
    input
    |> split_groups()
    |> count_answers(&all_answered/1)
  end

  def count_answers(groups, criteria) do
    groups
    |> Enum.map(criteria)
  ...
  def split_groups(input) do
    input
    |> String.split("\n\n")
    |> Enum.map(&split_people/1)
  end

  def split_people(group) do
    group
    |> String.split("\n")
    |> Enum.reject(& String.trim(&1) == "")
  end

  def distinct_answers(group) do
    group
    |> Enum.flat_map(&answers/1)
    |> Enum.uniq()
  end
  ...
  def answers(person) do
    StringUtils.split_chars(person)
  end
